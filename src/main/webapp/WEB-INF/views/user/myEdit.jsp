		...
		<div class="gtco-container">
			...
			<div class="row">
				<div class="col-sm-4 col-xs-12">
					<div id="gtco-logo"><a href="/">서울에서 배빵빵 <em>.</em></a></div>
				</div>
				<div class="col-xs-8 text-right menu-1">
					<ul>
						...
						<li class="btn-cta"><a href="/login"><span>로그아웃</span></a></li>
					</ul>	
				</div>
			</div>
				...
				<div class="col-md-12 col-md-offset-0 text-center">
					...
					<div class="row row-mt-8em">
						<div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
							<h2 class="white-color" style="font-size: 80px; font-weight: bold;">마이페이지</h2>
						</div>
			...
			<div class="row">
					<form:form action="${ pageContext.servletContext.contextPath }/user/myEdit?${_csrf.parameterName}=${_csrf.token}" method="POST" modelAttribute="user">
						<div class="row form-group" >
							<div class="col-md-12">
								<form:input path="uname" class="form-control" readonly="${true }"/>
							</div>
						</div>
						<div class="row form-group" >
							<div class="col-md-12">
						...
						<div class="row form-group" >
							<div class="col-md-12">
								<input type="submit" value="비밀번호변경" class="form-control" style="background-color:orange; color:white;">
							</div>
						</div>
					</form:form>	
